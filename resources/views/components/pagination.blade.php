<div>
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between md:flex-col">
                <div>
...
<div class="mt-8">
    <div class="flex justify-between flex-1 sm:hidden">
        @if ($paginator->onFirstPage())
            <span class="mx-1 px-3 py-2 bg-gray-200 text-gray-500 rounded-lg">
                {!! __('pagination.previous') !!}
            </span>
        @else
            <button type="button"
    ...
    <ul class="flex">
        <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-500 rounded-lg">
            ...
            @else
                <button type="button" wire:click="previousPage('{{ $paginator->getPageName() }}')" wire:loading.attr="disabled" dusk="previousPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}.before" class="flex items-center font-bold">
                    {!! __('pagination.previous') !!}
                </button>
            @endif
        </li>
        ...
        <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-700 hover:bg-gray-700 hover:text-gray-200 rounded-lg">
            <a href="#" class="flex items-center font-bold">Next</a>
        </li>
    </ul>
</div>